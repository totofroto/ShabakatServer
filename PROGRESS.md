...
- **Coordinator Decision Batch (2026-06-15):**
  - D1: `/api/speed-test/run` route commented out in `src/api/mod.rs`. `speed_test` module declaration commented out. Reason: uplink saturation on Celeron J4125 breaks passive mDNS/telemetry accuracy.
